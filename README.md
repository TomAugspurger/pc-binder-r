...
This branch is a binder-compatible repository for the `r` container from [planetary-computer-containers](https://github.com/microsoft/planetary-computer-containers).
